...
try {
    ...
    if (!$authRow || (int) ($authRow['is_admin'] ?? 0) !== 1) {
        header('Location: accesso-denegado.php');
        exit;
    }
...
<body>
    ...
    <div class="container" data-current-user="<?php echo $sessionUserIdEscaped; ?>" data-csrf-token="<?php echo $csrfTokenEscaped; ?>">
        ...
        <section class="welcome-hero text-center">
            ...
            <p class="section-description intro-description-centered">
                Consulta usuarios de tu empresa, su estado, el rol asignado y su último acceso.
        ...
        <section class="quick-links">
            <div class="feature-card">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <label for="usersRoleFilter" class="form-label">Rol</label>
