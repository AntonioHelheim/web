...
requireCapability($pdo, 'projects.assign_workers');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$proyecto['id_company'], 'proyectos', 'worker_projects', $idProject . ':' . $idWorker,
        'id_worker', $idWorker, null, 'unassign', (string)$proyecto['name']);
