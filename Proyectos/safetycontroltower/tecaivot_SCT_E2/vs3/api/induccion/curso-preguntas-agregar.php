...
requireCapability($pdo, 'induction.questions');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$curso['id_company'], 'induccion', 'company_test_rel_questions', $idRel,
        'id_question', null, $idPregunta . ' (puntaje ' . $puntaje . ')', 'assign', (string)$curso['name']);
