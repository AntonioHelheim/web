...
requireCapability($pdo, 'events.evidence_manage');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$evento['id_company'], 'eventos', 'security_event_evidence', $idEvidencia,
        'evidence', (string)($evidencia['original_name'] ?? $idEvidencia), null, 'remove', 'Evento #' . (int)$evidencia['id_security_events']);
