...
requireCapability($pdo, 'workers.photo');
...
try {
    ...
    auditTrailLogAction($pdo, (int) $trabajador['id_company'], 'trabajadores', 'workers', $idWorker,
        'photo_path', $trabajador['photo_path'] ?? null, $photoPathNuevo, 'upload', trim((string)$trabajador['name'].' '.(string)$trabajador['lastname']));
