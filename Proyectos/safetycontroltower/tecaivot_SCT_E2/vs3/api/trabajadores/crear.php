...
requireCapability($pdo, 'workers.create');
...
try {
    ...
    auditTrailLogChanges($pdo, $idCompany, 'trabajadores', 'workers', $idNuevo, [], array_merge($datos, ['state'=>1]),
        'create', trim($datos['name'] . ' ' . $datos['lastname']));
