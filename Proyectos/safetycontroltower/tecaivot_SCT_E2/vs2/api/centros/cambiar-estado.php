...
requireCapability($pdo, 'centers.state');
...
try {
    ...
    auditTrailLogAction($pdo, (int) $centro['id_company'], 'centros', 'company_center', $idCentro,
        'state', $centro['state'], $nuevoEstado, 'state_change', (string) $centro['name']);
