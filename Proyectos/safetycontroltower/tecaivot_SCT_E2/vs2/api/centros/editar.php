...
requireCapability($pdo, 'centers.edit');
...
try {
    ...
    centroActualizar($pdo, $idCentro, $nuevosDatos);
    auditTrailLogChanges($pdo, (int) $centro['id_company'], 'centros', 'company_center', $idCentro,
        $centro, array_merge($centro, $nuevosDatos), 'update', $name, ['name','description']);
