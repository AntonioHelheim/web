...
requireCapability($pdo, 'induction.materials');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$curso['id_company'], 'induccion', 'test_materials', $idMaterial,
        'material', (string)($material['title'] ?? $idMaterial), null, 'remove', (string)$curso['name']);
