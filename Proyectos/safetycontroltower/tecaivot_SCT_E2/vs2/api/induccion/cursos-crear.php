...
requireCapability($pdo, 'induction.create');
...
try {
    ...
    auditTrailLogChanges($pdo, $idCompany, 'induccion', 'company_test', $idNuevo, [], [
        'name'=>$name,'type'=>'induccion','description'=>$description,'attempts_allowed'=>$attemptsAllowed,
        'approval_percentage'=>$approvalPercentage,'effective_date_from'=>$fechaDesde->format('Y-m-d 00:00:00'),
        'effective_date_until'=>$fechaHasta->format('Y-m-d 23:59:59'),'state'=>1
    ], 'create', $name);
