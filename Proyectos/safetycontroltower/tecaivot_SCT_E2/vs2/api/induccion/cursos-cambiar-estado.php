...
requireCapability($pdo, 'induction.state');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$curso['id_company'], 'induccion', 'company_test', $idTest, 'state',
        $curso['state'], $nuevoEstado, 'state_change', (string)$curso['name']);
