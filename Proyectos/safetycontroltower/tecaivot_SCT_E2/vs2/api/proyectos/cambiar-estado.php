...
requireCapability($pdo, 'projects.state');
...
try {
    ...
    auditTrailLogAction($pdo, (int) $proyecto['id_company'], 'proyectos', 'projects', $idProject,
        'state', $proyecto['state'], $nuevoEstado, 'state_change', (string) $proyecto['name']);
