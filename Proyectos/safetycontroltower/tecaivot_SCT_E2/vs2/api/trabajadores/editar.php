...
requireCapability($pdo, 'workers.edit');
...
try {
    ...
    auditTrailLogChanges($pdo, (int) $trabajador['id_company'], 'trabajadores', 'workers', $idWorker,
        $trabajador, array_merge($trabajador, $datos), 'update', trim($datos['name'] . ' ' . $datos['lastname']),
