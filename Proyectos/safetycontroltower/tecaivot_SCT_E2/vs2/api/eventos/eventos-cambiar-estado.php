...
requireCapability($pdo, 'events.state');
...
try {
    ...
    auditTrailLogAction($pdo, (int)$evento['id_company'], 'eventos', 'security_events', $idEvento, 'state',
        $evento['state'], $nuevoEstado, 'state_change', 'Evento #' . $idEvento);
