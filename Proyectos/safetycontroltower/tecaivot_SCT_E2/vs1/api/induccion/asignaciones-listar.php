<?php
/**
 * GET /api/induccion/asignaciones-listar.php?id_test=7
 */
...
try {
    ...
    responderJSON(true, asignacionListarPorCurso($pdo, $idTest));
} catch (PDOException $e) {
    error_log('api/induccion/asignaciones-listar.php: ' . $e->getMessage());
    responderJSON(false, null, 'No se pudieron obtener las asignaciones.', 500);
}
