<!-- ============================================================
     ...
     Depende de: shared/globals/variables.css, navbar.css, navbar.js
     Reutilizable: sí — copiar carpeta components/navbar/ completa
     ============================================================ -->
<header id="header">
        ...
        <div class="container-fluid px-3 px-md-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto py-3 py-md-0">
                    ...
                    <li class="nav-item">
                        <a href="https://www.helheim.cl/Proyectos/Informes/indexscanner.php" class="nav-link">
                            <i class="bi bi-car-front me-1"></i> Escáner Vehicular
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="https://www.helheim.cl/Proyectos/DibujoTecnico/index.php" class="nav-link">
                            <i class="bi bi-pencil-square me-1"></i> Dibujo Técnico
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="https://www.helheim.cl/Proyectos/grabadolaser/index.php" class="nav-link">
                            <i class="bi bi-stars me-1"></i> Grabado Láser
                        </a>
                    </li>
