...
add_action( 'widgets_init', function () {
    register_widget( 'Weta_footer_info_two' );
} );

class Weta_footer_info_two extends WP_Widget {

    public function __construct() {
        parent::__construct( 'Weta_footer_info_two', esc_html__( 'Weta Footer Info 02', 'weta-core' ), array(
            'description' => esc_html__( 'Show Footer Info Two Widget By Weta', 'weta-core' ),
        ) );
    }
        ...
        <div class="footer__widget footer__widget-item-1">
            ...
            <div class="footer__logo mb-20">
                <a href="<?php print home_url();?>">
                    <img src="<?php print $image_box_image;?>" alt="<?php print esc_html__( 'Logo', 'weta-core' );?>">
                </a>
            </div>
            <?php endif;?>
            ...
            <div class="footer__subscribe mt-30">
    ...
    public function form( $instance ) {
		...
		<p>
			<label for="title"><?php esc_html_e( 'Form Shortcode:', 'weta-core' );?></label>
