...
add_action( 'widgets_init', function () {
    register_widget( 'Weta_footer_info' );
} );

class Weta_footer_info extends WP_Widget {

    public function __construct() {
        parent::__construct( 'Weta_footer_info', esc_html__( 'Weta Footer Info', 'weta-core' ), array(
    ...
    public function widget( $args, $instance ) {
	    ...
	    <div class="footer-widget">
	        ...
	        <h3 class="widget-header footer-logo">
	        ...
	        <p class="mb-30"><?php print $description;?></p>
	        <?php endif;?>
