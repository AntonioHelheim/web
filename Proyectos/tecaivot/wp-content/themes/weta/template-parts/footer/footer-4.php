...
<!-- Footer area start -->
<footer>
    <section class="dd footer-3__area-common theme-footer-bg-2 overflow-hidden" data-top-space="<?php print esc_attr($footer_top_space); ?>px" data-bg-color="<?php print esc_attr( $footer_bg_color );?>">
        <div class="container container-xxl">
            ...
            <?php if ( $footer_style_4_switch ) { if ( is_active_sidebar( 'footer-4-1' ) OR is_active_sidebar( 'footer-4-2' ) OR is_active_sidebar( 'footer-4-3' ) OR is_active_sidebar( 'footer-4-4' ) OR is_active_sidebar( 'footer-4-5' ) ): ?>
