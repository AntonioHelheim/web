...
class OverworldScene extends Phaser.Scene {
  ...
  create() {
    ...
    const myLabel = this.add.text(0, -TILE_SIZE * 0.75, window.POKEWEB_USER.username, {
  ...
  colorForTile(tile) {
    switch (tile) {
      ...
      case 5: return GB_PALETTE.trunk;
      case 6: return GB_PALETTE.rock;
      case 7: return GB_PALETTE.sand;
  ...
  updateRemotePlayers(players) {
    ...
    for (const p of players) {
      ...
      if (!remote) {
        remote = this.createRemotePlayer(p.username, p.appearance);
  ...
  createRemotePlayer(username, appearance) {
