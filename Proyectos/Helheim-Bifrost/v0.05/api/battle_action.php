...
try {
    ...
    // (calculateDamage), ejecutada acá en el servidor para que ambos
    // jugadores vean el mismo resultado sin importar la latencia de cada
    // uno, y para que ninguno pueda alterar el resultado editando su
    // propio JS. Si cambias la fórmula en un lado, cambia también en el
    // otro — ver la nota en battleRules.js (ítem 4 del roadmap:
    // unificar esto en una sola fuente de datos).
    $dmg = max(1, (int) round($mine['atk'] - $theirs['def'] / 2 + random_int(-2, 2)));
