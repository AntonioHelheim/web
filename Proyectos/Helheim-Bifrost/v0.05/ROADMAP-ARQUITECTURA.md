...
`node scripts/test-battle-rules.js`). `BattleScene.js` solo llama a estas
funciones y dibuja el resultado — ya no decide las reglas por su cuenta.
...
- *Depende de:* ~~idealmente el ítem 2 primero~~ — **ya resuelto**, este
  ítem queda desbloqueado.
...
**Resueltos:** ítem 2 (30-08-2026) — ver `js/core/battleRules.js`.

**Se pueden empezar ya, sin esperar nada:** ítem 3 (batallas silvestres
autoritativas — ya desbloqueado por el ítem 2), ítem 4 (catálogo
data-driven), ítem 5 (CSRF/rate-limiting en el resto de endpoints), y la
parte de testing de mapas del ítem 10.

Mi sugerencia concreta para seguir: **ítem 3** (batallas silvestres
autoritativas en el servidor) — ahora que las reglas ya están extraídas y
probadas, es el momento más barato para replicarlas en PHP y cerrar el
hueco de seguridad real que tiene hoy el juego. Dime si prefieres ese u
otro de los "ya se pueden empezar".
