...
- **`graphics-catalog.json`**: catálogo completo de `graphics/` (43
  archivos — Animations, Autotiles, Builds, Characters, Pictures), con la
  convención de grilla 4×4 documentada para cada categoría. Igual que el
  de audio, **todavía no hay ningún `.png` real en el proyecto** — es el
  catálogo/contrato a la espera de los archivos. El plan técnico de cómo
  se integra cada categoría (qué reemplaza, en qué orden) vive en
