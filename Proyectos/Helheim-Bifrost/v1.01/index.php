...
<main>
  ...
  <section class="gb-hero gb-hero-with-bg">
    <div class="gb-hero-bg gb-hero-bg-a" style="background-image:url('graphics/animations/bkgindex1.png?v=<?= urlencode($ASSET_VERSION) ?>')" aria-hidden="true"></div>
    <div class="gb-hero-bg gb-hero-bg-b" style="background-image:url('graphics/animations/bkgindex2.png?v=<?= urlencode($ASSET_VERSION) ?>')" aria-hidden="true"></div>
    <div class="gb-hero-clouds" style="background-image:url('graphics/animations/clouds.png?v=<?= urlencode($ASSET_VERSION) ?>')" aria-hidden="true"></div>
