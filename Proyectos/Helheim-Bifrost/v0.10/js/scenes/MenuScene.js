...
class MenuScene extends Phaser.Scene {
  ...
  create() {
    console.log('[Bifrost] MenuScene.create()');
  ...
  openAppearanceEditor() {
    console.log('[Bifrost] Cambiar apariencia clickeado, actionTaken =', this.actionTaken);
  ...
  closeMenu() {
    console.log('[Bifrost] closeMenu(), actionTaken =', this.actionTaken);
    if (this.actionTaken) return;
    this.actionTaken = true;
    this.scene.stop();
