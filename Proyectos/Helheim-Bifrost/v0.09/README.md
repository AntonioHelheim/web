...
├── scripts/
│   ├── check-maps.js               # Conectividad + warps de todos los mapas — ver ROADMAP ítem 10
│   └── test-battle-rules.js       # Prueba battleRules.js con Node, sin navegador — ver ROADMAP ítem 2
...
└── sql/
    ...
    └── 007_wild_battles.sql              # Migración: tabla wild_battles
```
