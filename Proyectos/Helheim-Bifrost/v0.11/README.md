...
colores propios, no una recreación de personajes de ninguna franquicia
existente. Los personajes usan proporción "chibi" (cabeza grande,
...
31-08-2026 en general), importa `sql/v1.0-seed-migration.sql`. Si es una
instalación mucho más vieja que nunca actualizaste, revisa
...
└── sql/
    ├── schema.sql                # Esquema v1.0-seed completo (instalación nueva)
    ├── v1.0-seed-migration.sql   # Actualiza una base existente (de antes del 31-08-2026) sin perder datos
    └── archive/                  # Migraciones históricas 002-007, ya no hace falta importarlas (ver archive/README.md)
```
