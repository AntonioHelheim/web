...
try {
    ...
    // Cálculo de daño: idéntico al de la batalla contra criaturas salvajes,
    // pero ejecutado en el servidor para que ambos jugadores vean el mismo
    // resultado sin importar la latencia de cada uno.
