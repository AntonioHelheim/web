...
if ($result && $result->num_rows > 0) {
    ...
    $html .= '<table><thead><tr>
        ...
        <th class="center" style="width:5%;">Fec. Plan.</th>
        <th class="center" style="width:6%;">Entorno Plan</th>
    ...
    // Agregar fila resumen de totales
    $html .= '<tr class="bold">
...
$dompdf->stream("Listado_Actividades_No_Realizadas.pdf", ["Attachment" => false]);
exit;
